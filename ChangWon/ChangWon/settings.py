"""
Django settings for ChangWon project.
...
SECRET_KEY = 'ef%40y%!rw28bt2j^k1^iuyl0tvfi)&j0r%ny4-b(z6wl5l+97'
...
WSGI_APPLICATION = 'ChangWon.wsgi.application'
